...
var bio = {
	...
	'welcomeMessage' : 'Welcome! Bienvenido! In just one paper you are going to know what I am, what I do, and what Ive been doing.',
...
projects.display = function () {
	for (project in projects.projects){
		...
		if (projects.projects[project].images.length > 0) {
            ...
            $('.project-entry:last').append('<center>' + formattedImage + '</center>');
		}
	}
}
